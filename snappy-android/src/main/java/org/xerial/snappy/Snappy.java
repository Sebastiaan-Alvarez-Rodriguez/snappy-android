/*--------------------------------------------------------------------------
 *  Copyright 2011 Sebastiaan Alvarez Rodriguez
 *
 ...
 * Changes:
 *  - Made a call rerouter to android-specific interface.
 *  - Fixed style.
 *  - Fixed javadocs.
 *--------------------------------------------------------------------------*/
...
import org.sebastiaan.snappy_android.SnappyError;
import org.sebastiaan.snappy_android.SnappyErrorCode;
...
/**
 * Snappy-Java API rerouter to Snappy-Android
 * <p/>
...
public class Snappy {
    ...
    public static void cleanUp() {
        org.sebastiaan.snappy_android.Snappy.cleanUp();
    }
     ...
     */
     public static void arrayCopy(Object src, int offset, int byteLength, Object dest, int dest_offset) throws IOException { 
        org.sebastiaan.snappy_android.Snappy.arrayCopy(src, offset, byteLength, dest, dest_offset);
     }
     ...
     */
     public static byte[] compress(byte[] input) throws IOException { 
        return org.sebastiaan.snappy_android.Snappy.compress(input);
     }
     ...
     */
     public static int compress(byte[] input, int inputOffset, int inputLength, byte[] output, int outputOffset) throws IOException { 
        return org.sebastiaan.snappy_android.Snappy.compress(input, inputOffset, inputLength, output, outputOffset);
     }
     ...
     */
     public static int compress(ByteBuffer uncompressed, ByteBuffer compressed) throws IOException { 
        return org.sebastiaan.snappy_android.Snappy.compress(uncompressed, compressed);
     }
    ...
    public static byte[] compress(String s) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.compress(s);
    }
    ...
    public static byte[] compress(String s, String encoding) throws UnsupportedEncodingException, IOException {
        return org.sebastiaan.snappy_android.Snappy.compress(s, encoding);
    }
    ...
    public static String getNativeLibraryVersion() {
        return org.sebastiaan.snappy_android.Snappy.getNativeLibraryVersion();
    }
    ...
    public static boolean isValidCompressedBuffer(byte[] input, int offset, int length) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.isValidCompressedBuffer(input, offset, length);
    }
     ...
     */
     public static boolean isValidCompressedBuffer(byte[] input) throws IOException {
         return org.sebastiaan.snappy_android.Snappy.isValidCompressedBuffer(input);
     }
    ...
    public static boolean isValidCompressedBuffer(ByteBuffer compressed) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.isValidCompressedBuffer(compressed);
    }
     ...
     */
     public static boolean isValidCompressedBuffer(long inputAddr, long offset, long length) throws IOException {
         return org.sebastiaan.snappy_android.Snappy.isValidCompressedBuffer(inputAddr, offset, length);
     }
     ...
     */
     public static int maxCompressedLength(int byteSize) { 
        return org.sebastiaan.snappy_android.Snappy.maxCompressedLength(byteSize);
     }
     ...
     */
     public static long rawCompress(long inputAddr, long inputSize, long destAddr) throws IOException { 
        return org.sebastiaan.snappy_android.Snappy.rawCompress(inputAddr, inputSize, destAddr);
     }
     ...
     */
     public static long rawUncompress(long inputAddr, long inputSize, long destAddr) throws IOException { 
        return org.sebastiaan.snappy_android.Snappy.rawUncompress(inputAddr, inputSize, destAddr);
     }
    ...
    public static byte[] rawCompress(Object data, int byteSize) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.rawCompress(data, byteSize);
    }
    ...
    public static int rawCompress(Object input, int inputOffset, int inputLength, byte[] output, int outputOffset) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.rawCompress(input, inputOffset, inputLength, output, outputOffset);
    }
    ...
    public static int rawUncompress(byte[] input, int inputOffset, int inputLength, Object output, int outputOffset) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.rawUncompress(input, inputOffset, inputLength, output, outputOffset);
    }
    ...
    public static byte[] uncompress(byte[] input) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.uncompress(input);
    }
     ...
     */
     public static int uncompress(byte[] input, int inputOffset, int inputLength, byte[] output, int outputOffset) throws IOException { 
        return org.sebastiaan.snappy_android.Snappy.uncompress(input, inputOffset, inputLength, output, outputOffset);
     }
    ...
    public static int uncompress(ByteBuffer compressed, ByteBuffer uncompressed) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.uncompress(compressed, uncompressed);
    }
     ...
     */
     public static char[] uncompressCharArray(byte[] input) throws IOException { 
        return org.sebastiaan.snappy_android.Snappy.uncompressCharArray(input);
     }
    ...
    public static char[] uncompressCharArray(byte[] input, int offset, int length) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.uncompressCharArray(input, offset, length);
    }
    ...
    public static double[] uncompressDoubleArray(byte[] input) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.uncompressDoubleArray(input);
    }
     ...
     */
     public static int uncompressedLength(byte[] input) throws IOException { 
        return org.sebastiaan.snappy_android.Snappy.uncompressedLength(input);
     }
    ...
    public static int uncompressedLength(byte[] input, int offset, int length) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.uncompressedLength(input, offset, length);
    }
    ...
    public static int uncompressedLength(ByteBuffer compressed) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.uncompressedLength(compressed);
    }
     ...
     */
     public static long uncompressedLength(long inputAddr, long len) throws IOException { 
        return org.sebastiaan.snappy_android.Snappy.uncompressedLength(inputAddr, len);
     }
     ...
     */
     public static float[] uncompressFloatArray(byte[] input) throws IOException { 
        return org.sebastiaan.snappy_android.Snappy.uncompressFloatArray(input);
     }
    ...
    public static float[] uncompressFloatArray(byte[] input, int offset, int length) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.uncompressFloatArray(input, offset, length);
    }
     ...
     */
     public static int[] uncompressIntArray(byte[] input) throws IOException { 
        return org.sebastiaan.snappy_android.Snappy.uncompressIntArray(input);
     }
    ...
    public static int[] uncompressIntArray(byte[] input, int offset, int length) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.uncompressIntArray(input, offset, length);
    }
     ...
     */
     public static long[] uncompressLongArray(byte[] input) throws IOException { 
        return org.sebastiaan.snappy_android.Snappy.uncompressLongArray(input);
     }
    ...
    public static long[] uncompressLongArray(byte[] input, int offset, int length) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.uncompressLongArray(input, offset, length);
    }
     ...
     */
     public static short[] uncompressShortArray(byte[] input) throws IOException { 
        return org.sebastiaan.snappy_android.Snappy.uncompressShortArray(input);
     }
    ...
    public static short[] uncompressShortArray(byte[] input, int offset, int length) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.uncompressShortArray(input, offset, length);
    }
    ...
    public static String uncompressString(byte[] input) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.uncompressString(input);
    ...
    public static String uncompressString(byte[] input, int offset, int length) throws IOException {
        return org.sebastiaan.snappy_android.Snappy.uncompressString(input, offset, length);
    }
    ...
    public static String uncompressString(byte[] input, int offset, int length, String encoding) throws IOException, UnsupportedEncodingException {
        return org.sebastiaan.snappy_android.Snappy.uncompressString(input, offset, length, encoding);
    }
    ...
    public static String uncompressString(byte[] input, String encoding) throws IOException, UnsupportedEncodingException {
        return org.sebastiaan.snappy_android.Snappy.uncompressString(input, encoding);
    }
