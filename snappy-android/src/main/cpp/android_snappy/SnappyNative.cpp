...
#include <cstring>
#include <snappy.h>
//#include "vendored/snappy/snappy.h"
...
extern "C" JNIEXPORT jstring JNICALL Java_org_sebastiaan_snappy_1android_SnappyNative_nativeLibraryVersion
		(JNIEnv * env, jobject self)
{
	// TODO: Do we need to read this library version from resources/lib/org/xerial/snappy/VERSION?
	return env->NewStringUTF("1.1.3");
}

extern "C" JNIEXPORT jlong JNICALL Java_org_sebastiaan_snappy_1android_SnappyNative_rawCompress__JJJ
...
extern "C" JNIEXPORT jlong JNICALL Java_org_sebastiaan_snappy_1android_SnappyNative_rawUncompress__JJJ
		(JNIEnv* env, jobject self, jlong srcAddr, jlong length, jlong destAddr) {
 ...
 */
extern "C" JNIEXPORT jint JNICALL Java_org_sebastiaan_snappy_1android_SnappyNative_rawCompress__Ljava_nio_ByteBuffer_2IILjava_nio_ByteBuffer_2I
...
extern "C" JNIEXPORT jint JNICALL Java_org_sebastiaan_snappy_1android_SnappyNative_rawCompress__Ljava_lang_Object_2IILjava_lang_Object_2I
...
extern "C" JNIEXPORT jint JNICALL Java_org_sebastiaan_snappy_1android_SnappyNative_rawUncompress__Ljava_lang_Object_2IILjava_lang_Object_2I
 ...
 */
extern "C" JNIEXPORT jint JNICALL Java_org_sebastiaan_snappy_1android_SnappyNative_rawUncompress__Ljava_nio_ByteBuffer_2IILjava_nio_ByteBuffer_2I
...
extern "C" JNIEXPORT jint JNICALL Java_org_sebastiaan_snappy_1android_SnappyNative_maxCompressedLength
 ...
 */
extern "C" JNIEXPORT jint JNICALL Java_org_sebastiaan_snappy_1android_SnappyNative_uncompressedLength__Ljava_nio_ByteBuffer_2II
...
extern "C" JNIEXPORT jint JNICALL Java_org_sebastiaan_snappy_1android_SnappyNative_uncompressedLength__Ljava_lang_Object_2II
...
extern "C" JNIEXPORT jlong JNICALL Java_org_sebastiaan_snappy_1android_SnappyNative_uncompressedLength__JJ
...
extern "C" JNIEXPORT jboolean JNICALL Java_org_sebastiaan_snappy_1android_SnappyNative_isValidCompressedBuffer__Ljava_nio_ByteBuffer_2II
		(JNIEnv * env, jobject self, jobject compressed, jint cpos, jint clen)
{
	char* compressedBuffer = (char*) env->GetDirectBufferAddress(compressed);
	if(compressedBuffer == 0) {
...
extern "C" JNIEXPORT jboolean JNICALL Java_org_sebastiaan_snappy_1android_SnappyNative_isValidCompressedBuffer__Ljava_lang_Object_2II
		(JNIEnv * env, jobject self, jobject input, jint offset, jint length)
{
	char* in = (char*) env->GetPrimitiveArrayCritical((jarray) input, 0);
	if(in == 0) {
...
extern "C" JNIEXPORT jboolean JNICALL Java_org_sebastiaan_snappy_1android_SnappyNative_isValidCompressedBuffer__JJJ
...
//Object src, int offset, int byteLength, Object dest, int dOffset)
extern "C" JNIEXPORT void JNICALL Java_org_sebastiaan_snappy_1android_SnappyNative_arrayCopy
